  ...
  return (
    <>
      <form className="mt-5">
        ...
        <label className="form-label mt-3 text-white">Phone Number</label>
        <input type="email" className="form-control" />
        <label className="form-label mt-3 text-white">Email address</label>
        <input type="email" className="form-control" />
        ...
        <label className="form-label mt-3 text-white">Confirm Password</label>
        <div className="position-relative">
          <input type="password" className="form-control" />
          <i className="fa-solid fa-unlock position-absolute top-50 end-0 translate-middle-y me-3"></i>
          <i className="fa-solid fa-lock position-absolute top-50 end-0 translate-middle-y me-3"></i>
